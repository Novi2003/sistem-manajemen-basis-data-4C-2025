...
('Warung Sambel Hejo', 1, 1, 1, 1, 'Jl. Pahlawan No. 123, Bandung', '9120001234567', '09.876.543.2-123.000', '2018-05-12', 3, 35000000, 250000000, 'Warung makan spesialis sambel khas Sunda dengan aneka lauk', '2022-03-15'),
('Butik Batik Pesona', 2, 2, 2, 2, 'Jl. Merdeka No. 45, Bekasi', '9120001234568', '09.876.543.2-123.001', '2015-09-11', 7, 320000000, 1200000000, 'Butik batik dengan motif khas Jawa Barat', '2021-07-20'),
('Kerajinan Anyaman Rahayu', 3, 3, 1, 1, 'Jl. Sukajadi No. 78, Bandung', '9120001234569', '09.876.543.2-123.002', '2019-06-25', 5, 45000000, 280000000, 'Produk kerajinan anyaman bambu dan rotan', '2022-01-10'),
('Taman Buah Sejahtera', 4, 4, 2, 3, 'Jl. Veteran No. 56, Bogor', '9120001234570', '09.876.543.2-123.003', '2014-02-27', 10, 450000000, 2000000000, 'Pertanian buah-buahan lokal dan jeruk impor', '2020-11-05'),
('Ternak Ayam Makmur', 5, 5, 1, 12, 'Jl. Cendana No. 34, Bekasi', '9120001234571', '09.876.543.2-123.004', '2020-01-18', 4, 48000000, 275000000, 'Peternakan ayam dan pengolahan telur', '2022-02-28'),
('Budidaya Ikan Barokah', 6, 6, 2, 4, 'Jl. Kemuning No. 67, Cimahi', '9120001234572', '09.876.543.2-123.005', '2017-03-01', 8, 380000000, 1800000000, 'Budidaya ikan air tawar dan olahan ikan', '2021-04-12'),
('Bengkel Las Abadi', 7, 7, 1, 10, 'Jl. Teratai No. 89, Bandung', '9120001234573', '09.876.543.2-123.006', '2016-05-23', 6, 49000000, 290000000, 'Jasa pengelasan dan pembuatan pagar', '2022-05-17'),
('Toko Sembako Barokah', 8, 8, 2, 17, 'Jl. Cikutra No. 23, Garut', '9120001234574', '09.876.543.2-123.007', '2013-07-10', 5, 420000000, 2300000000, 'Perdagangan sembako dan kebutuhan rumah tangga', '2020-08-23'),
('Furniture Kayu Jati', 9, 9, 3, 15, 'Jl. Sudirman No. 56, Cianjur', '9120001234575', '09.876.543.2-123.008', '2012-12-31', 20, 2500000000, 15000000000, 'Produksi furniture kayu jati untuk ekspor', '2020-03-10'),
('Digital Solution', 10, 10, 2, 16, 'Jl. Gatot Subroto No. 78, Cirebon', '9120001234576', '09.876.543.2-123.009', '2018-04-09', 12, 480000000, 2200000000, 'Pengembangan aplikasi dan website', '2021-09-15'),
('Homestay Panorama', 11, 11, 1, 20, 'Jl. Setiabudi No. 90, Kuningan', '9120001234577', '09.876.543.2-123.010', '2019-06-12', 4, 47000000, 270000000, 'Penyedia akomodasi homestay di daerah wisata', '2022-04-21'),
('Studio Desain Kreatif', 12, 12, 2, 21, 'Jl. Pasteur No. 45, Majalengka', '9120001234578', '09.876.543.2-123.011', '2016-09-15', 8, 350000000, 1900000000, 'Jasa desain grafis dan branding', '2021-05-17'),
('Oleh-oleh Khas Sunda', 13, 1, 2, 23, 'Jl. Ciganitri No. 67, Purwakarta', '9120001234579', '09.876.543.2-123.012', '2015-08-13', 9, 370000000, 2100000000, 'Makanan oleh-oleh khas Sunda Buhun', '2020-10-30'),
('Rajutan Cantik', 14, 2, 1, 26, 'Jl. Cibaduyut No. 23, Sumedang', '9120001234580', '09.876.543.2-123.013', '2020-05-07', 3, 40000000, 260000000, 'Produk rajutan handmade berkualitas', '2022-02-14'),
('Perkebunan Kopi Gunung', 15, 4, 3, 27, 'Jl. Anggrek No. 76, Tasikmalaya', '9120001234581', '09.876.543.2-123.014', '2010-06-11', 25, 3500000000, 20000000000, 'Perkebunan dan pengolahan kopi premium', '2020-01-05');
